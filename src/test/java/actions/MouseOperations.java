...
public class MouseOperations {
	...
	public void autosuggestions() throws Exception {
		...
		driver.get("https://www.google.co.in/");
		WebElement sleval=driver.findElement(By.name("q"));
		//driver.findElement(By.name("btnK")).click();
		driver.findElement(By.name("q")).getAttribute("value");
		
		sleval.sendKeys("selenium");
		Thread.sleep(3000);
		sleval.sendKeys(Keys.ARROW_DOWN,Keys.ARROW_DOWN,Keys.ARROW_DOWN,Keys.ENTER);
	...
	String sle1=driver.findElement(By.name("q")).getAttribute("value");
	...
	for(int i=0;i<list.size();i++)
	{
		...
		if(list.get(i).getText().equals(sle1))
		{
			list.get(i).click();
			return;
		}
